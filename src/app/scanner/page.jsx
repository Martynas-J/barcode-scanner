    ...
    <div className="container mx-auto text-center">
      ...
      {scannedCode && (
        <div>
          ...
          <Link className="flex justify-end bg-gray-800 border-2 shadow-xl border-gray-800 text-white py-3 px-6 rounded-md font-bold  hover:bg-white hover:text-gray-800  focus:outline-none  focus:bg-white focus:text-gray-800 w-70px" href="/#">Atgal</Link>
        </div>
      )}
      {error && (
        <div>
